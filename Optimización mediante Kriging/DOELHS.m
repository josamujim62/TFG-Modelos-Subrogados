...
X=dRE_norm; 
Y=db_datos(:,9:12);
[Y_temp, ps_y] = mapminmax(Y',0,1);
Y_norm=Y_temp';
% save db_datos200LHS.mat X Y Y_norm ps_y dRE
% save db_datos500LHS.mat X Y Y_norm ps_y dRE
save db_datos1000LHS.mat X Y Y_norm ps_y dRE